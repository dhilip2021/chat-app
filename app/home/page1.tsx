...
const HomePage: React.FC = () => {
  ...
  // Code-la indha state-ah add panniko machi
  const [showInviteModal, setShowInviteModal] = useState(false);
  const [copied, setCopied] = useState(false);

  const handleCopyLink = () => {
    const inviteLink = `https://chatoo.app/join/${currentChat?.name.toLowerCase().replace(/\s/g, "-")}`;
        ...
        <div className="p-6 pb-2">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => setShowSettings(!showSettings)}
                className="md:hidden w-10 h-10 rounded-xl overflow-hidden border border-white/10"
              >
          ...
          {showSettings && (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 text-sm font-bold text-red-500 hover:bg-red-500/10 rounded-xl"
              >
                Logout
              </button>
            </motion.div>
              ...
              {currentChat.type === "groups" && (
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className="p-2 bg-purple-600/20 text-purple-400 rounded-xl hover:bg-purple-600 hover:text-white transition-all ml-2"
                  >
                    <div className="flex items-center gap-2 px-2">
                      <svg
                        className="w-5 h-5"
